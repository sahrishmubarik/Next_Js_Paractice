...
import photo1 from "./photo/images (1).jpg";
import photo2 from "./photo/images (2).jpg";
import photo3 from "./photo/images (3).jpg";
import photo4 from "./photo/images (4).jpg";
import photo5 from "./photo/images (5).jpg";
import photo6 from "./photo/images (6).jpg";
import photo7 from "./photo/images (7).jpg";
